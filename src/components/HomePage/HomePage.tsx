            ...
            <div className={styles.content}>
                ...
                <div className={'max-w-[1100px] mx-auto mt-14'}>
                    ...
                    <div className={'grid grid-cols-4 gap-y-10 max-w-[1100px] mx-auto mb-32'}>
                        <Case title={"КекПукПек"} id={0} image={Custom1} price={56} width={156} height={156} desc={"хер пойми что важно"} imgStyles={'mt-4 mb-4'}/>
                        <Case title={"КекПукПек"} id={1} image={Custom1} price={56} width={156} height={156} desc={"хер пойми что важно"} imgStyles={'mt-4 mb-4'}/>
                        <Case title={"КекПукПек"} id={2} image={Custom1} price={56} width={156} height={156} desc={"хер пойми что важно"} imgStyles={'mt-4 mb-4'}/>
                        <Case title={"КекПукПек"} id={3} image={Custom1} price={56} width={156} height={156} desc={"хер пойми что важно"} imgStyles={'mt-4 mb-4'}/>
                    </div>
                    ...
                    <div className={'grid grid-cols-4 gap-y-10 max-w-[1100px] mx-auto pb-[100px]'}>
                        <Case title={"КекПукПек"} id={4} image={CaseImg} price={56} desc={"хер пойми что важно"} imgStyles={'mb-4 mt-4'}/>
                        <Case title={"КекПукПек"} id={5} image={CaseImg} price={56} desc={"хер пойми что важно"} imgStyles={'mb-4 mt-4'}/>
                        <Case title={"КекПукПек"} id={6} image={CaseImg} price={56} desc={"хер пойми что важно"} imgStyles={'mb-4 mt-4'}/>
                        <Case title={"КекПукПек"} id={7} image={CaseImg} price={56} desc={"хер пойми что важно"} imgStyles={'mb-4 mt-4'}/>
                        <Case title={"КекПукПек"} id={8} image={CaseImg} price={56} desc={"хер пойми что важно"} imgStyles={'mb-4 mt-4'}/>
                        <Case title={"КекПукПек"} id={9} image={CaseImg} price={56} desc={"хер пойми что важно"} imgStyles={'mb-4 mt-4'}/>
                        <Case title={"КекПукПек"} id={10} image={CaseImg} price={56} desc={"хер пойми что важно"} imgStyles={'mb-4 mt-4'}/>
                        <Case title={"КекПукПек"} id={11} image={CaseImg} price={56} desc={"хер пойми что важно"} imgStyles={'mb-4 mt-4'}/>
                        <Case title={"КекПукПек"} id={12} image={CaseImg} price={56} desc={"хер пойми что важно"} imgStyles={'mb-4 mt-4'}/>
                        <Case title={"КекПукПек"} id={13} image={CaseImg} price={56} desc={"хер пойми что важно"} imgStyles={'mb-4 mt-4'}/>
                        <Case title={"КекПукПек"} id={14} image={CaseImg} price={56} desc={"хер пойми что важно"} imgStyles={'mb-4 mt-4'}/>
                        <Case title={"КекПукПек"} id={15} image={CaseImg} price={56} desc={"хер пойми что важно"} imgStyles={'mb-4 mt-4'}/>
                    </div>
                </div>
            </div>
